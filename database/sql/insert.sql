-- seller
INSERT INTO `seller_company` (`id`, `name`) VALUES
    (1, "회사1"),
    (2, "히사입니다"),
    (3, "여긴회사");

INSERT INTO `seller_seller` (`id`, `company_id`, `name`, `phone_number`) VALUES
    (1, 1, "아이야", "00011112222"),
    (2, 1, "홍길동", "11012341234"),
    (3, 2, "아아호", "11043214321"),
    (4, 3, "사람임", "13212452352");
...
-- venue
INSERT INTO `venue_venue` (`id`, `name`, `road_address`, `latitude`, `longitude`, `capacity`) VALUES
    (1, 'KSPO DOME (올림픽 체조경기장)', '서울 송파구 올림픽로 424', 37.521074, 127.116112, 15000),
...
INSERT INTO `venue_layout` (`venue_id`, `company_id`, `name`, `is_local`, `created_at`, `updated_at`) VALUES
    (1, 1, 'A구역', true, NOW(), NOW()),
    (1, 2, 'B구역', true, NOW(), NOW()),
    (1, 1, 'C구역', true, NOW(), NOW()),
    (2, 1, 'D구역', false, NOW(), NOW()),
    (2, 3, 'E구역', false, NOW(), NOW()),
    (3, 1, 'F구역', true, NOW(), NOW()),
    (3, 2, 'G구역', true, NOW(), NOW()),
    (4, 1, 'H구역', true, NOW(), NOW()),
    (4, 3, 'I구역', true, NOW(), NOW());

INSERT INTO `venue_area` (`layout_id`, `name`, `price`) VALUES
    (1, 'A1 구역', 10000),
    (1, 'A2 구역', 15000),
    (2, 'B1 구역', 12000),
    (2, 'B2 구역', 16000),
...
-- concert
INSERT INTO `concert_concert` (`company_id`, `venue_id`, `venue_layout_id`, `title`, `duration`, `started_at`, `ended_at`,
                               `booking_started_at`, `booking_ended_at`, `is_sellable`, `is_deleted`, `created_at`,
                               `updated_at`, `thumbnail`, `description`) VALUES
    (1, 1, 1, '아이유 전국투어 - 서울', 200, '2025-06-01 18:00:00', '2025-06-01 21:00:00',
...
INSERT INTO concert_detail_image (concert_id, image_url) VALUES
     (1, 'iu_seoul_1.jpg'),
     (1, 'iu_seoul_2.jpg'),
     (1, 'iu_seoul_3.jpg'),
